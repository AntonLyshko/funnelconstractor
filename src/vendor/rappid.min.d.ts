...
export namespace dia {
    ...
    class Cell extends Backbone.Model {
        source(model: any, arg1: { connectionPoint: { name: string; args: { offset: number; stroke: boolean; }; }; }) {
            throw new Error("Method not implemented.");
        }
        target(target_cell: Cell, arg1: { connectionPoint: { name: string; args: { offset: { x: number; y: number; }; stroke: boolean; }; }; }) {
            throw new Error("Method not implemented.");
        }
        updateOnlyOptions() {
            throw new Error('Method not implemented.');
    ...
    class ElementView extends CellViewGeneric<Element> {
        _portElementsCache(_portElementsCache: any) {
            throw new Error("Method not implemented.");
        }
